/**
 * Chrome content script — replaces .ytp-time-duration with
 * duration / playbackRate (total length at current speed).
 * Does not tick down with playback. Leaves .ytp-time-current alone.
 */
(function () {
