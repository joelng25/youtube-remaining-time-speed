/**
 * Scales YouTube player times by playback speed without flicker.
 * Hides native .ytp-time-current / .ytp-time-duration and shows our own
 * sibling labels — YouTube can update its nodes freely; we never fight them.
 *
 *   left  = currentTime / rate  (or -remaining/rate)
 *   right = duration / rate
 */
(function () {
